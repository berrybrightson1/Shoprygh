...
export default function PlatformLanding() {
    return (
        <div className="min-h-screen bg-white flex flex-col font-sans text-gray-900">
            ...
            {/* Hero Section */}
            <main className="flex-1 flex flex-col items-center justify-center text-center px-4 py-20 lg:py-32 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-gray-50 via-white to-white overflow-hidden">
                ...
                <h1 className="text-5xl md:text-7xl font-black tracking-tight text-gray-900 mb-6 max-w-4xl animate-in fade-in slide-in-from-bottom-8 duration-700">
                ...
                <p className="text-lg md:text-xl text-gray-500 max-w-2xl mb-10 leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-100">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
                    <Link href="/signup" className="w-full sm:w-auto bg-black text-white px-8 py-4 rounded-full text-lg font-bold hover:bg-gray-800 transition hover:scale-105 active:scale-95 shadow-xl shadow-black/10 flex items-center justify-center gap-2">
                        Get Started for Free
                        <ArrowRight size={18} />
                    </Link>
                    <Link href="/login" className="w-full sm:w-auto px-8 py-4 rounded-full text-lg font-bold text-gray-600 hover:bg-gray-50 transition border border-gray-200 hover:border-gray-300">
                        View Demo
                    </Link>
                </div>

                {/* Social Proof / Trust */}
                <div className="mt-16 pt-8 border-t border-gray-100 w-full max-w-md animate-in fade-in zoom-in duration-1000 delay-300">
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Trusted by modern brands</p>
